...
class JsonTest(object):
    ...
    def __init__(self, base_url):
        ...
        self.headers = {}
        self.token = None
    def ho_register(self,ho_name,ho_account,ho_password,ho_tel,ho_mobile,ho_nicard,ho_image,ho_email,ho_createtime,path = "/api/v1.0/ho_register"):
        entity = {"ho_name":ho_name,"ho_password":ho_password,"ho_tel":ho_tel,"ho_mobile":ho_mobile,"ho_nicard":ho_nicard,
                  "ho_image":ho_image,"ho_email":ho_email,"ho_createtime":ho_createtime}
